<%@ WebHandler Language="VB" Class="pbmUpdateResponses" %>
...
Public Class pbmUpdateResponses : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            Using objConn As New SqlConnection(ConfigurationManager.ConnectionStrings("objConn").ConnectionString)
                Using objCmd As New SqlCommand("updatePBM360FormResponses", objConn)
